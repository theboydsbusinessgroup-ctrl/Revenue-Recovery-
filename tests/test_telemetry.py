...
class TelemetryTests(unittest.TestCase):
    def test_snapshot_excludes_pii_and_preserves_truth(self):
        ...
        self.assertEqual(snap['metrics']['source_signal_references'],1)
        self.assertEqual(snap['metrics']['duplicate_source_signals_collapsed'],0)
        ...
        self.assertTrue(snap['truth_rules']['source_signals_are_not_canonical_opportunities'])
